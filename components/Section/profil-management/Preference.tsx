...
export default function Preference(): JSX.Element {
  return (
    <div className="w-2/3 flex items-start justify-start h-full flex-col p-20 px-32">
      <p className="text-youcast-white text-2xl">Modifier mes préferences</p>
      <div className="h-0.5 bg-youcast-hover w-full mt-8 mb-6"></div>
      <p className="text-youcast-white text-sm tracking-wide font-light"></p>
      //TODO : GERER LES PREFERENCES
      {/* <form>
